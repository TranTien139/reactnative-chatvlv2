...
class Hot extends Component {
  ...
  _fetchData(callback) {
      axios.post(domain+'/articles/getHotArticle',{user_id: "0", type:1, size:10, page: this.state.page}).then(response=>{
...
export default connect(mapStateToProps, actions)(Hot);